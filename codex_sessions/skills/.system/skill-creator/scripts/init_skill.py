...
**2. TaSK_REDACTED (best for tool collections)
...
Patterns can be mixed and matched as needed. Most skills combine patterns (e.g., start with taSK_REDACTED add workflow for complex operations).
