...
pre-commit install
请你帮我在cli里登录我自己的wandb账号，邮箱是jiangkh5521@gmail.com 请继续你的任务，完成全量训练在tmux里
...
继续你的任务，定时执行export http_proxy=http://127.0.0.1:7898 https_proxy=http://127.0.0.1:7898 all_proxy=http://127.0.0.1:7898命令以稳定网络连接
...
```
谷歌搜索引擎的api key是：0ec804b592087df08dc3a0d98ac5cbb67ad549db